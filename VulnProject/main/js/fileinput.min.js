...
!(function (e) {
  ...
  (t = {
    ...
    getFileRelativePath: function (e) {
      return String(
        e.relativePath || e.webkitRelativePath || t.getFileName(e) || null
      );
    },
    ...
    (i.prototype = {
      ...
      _initAjax: function () {
        ...
        (e.ajaxQueue = []),
          (e.ajaxRequests = []),
          (e.ajaxQueueIntervalId = null),
          (e.ajaxCurrentThreads = 0),
          (e.ajaxAborted = !1);
      },
      _init: function (i, a) {
        var r,
      ...
      _initFileManager: function () {
        ...
        i.fileManager = {
          ...
          isPending: function (t) {
            return (
              -1 === e.inArray(t, i.fileManager.processed) &&
          ...
          (i.resumableManager = {
              ...
              (a.completed = !0),
                ...
                "success" === e
                  ? (i.showPreview &&
                      ...
                      i._initUploadSuccess(a.processed[n].data, o)),
                    i.fileManager.removeFile(n),
                    delete a.processed[n],
            ...
            check: function () {
              ...
              e.each(t.logs, function (e, t) {
                ...
                a &&
                  (clearInterval(t.chunkIntervalId), t.setProcessed("success"));
            },
            ...
            sendAjax: function (e, a) {
              ...
              if (!l.processed[c] || !l.processed[c][e]) {
                if ((l.currThreads++, a > s.maxRetries))
                  return void l.setProcessed("error");
                var g,
                  m,
                  v,
                  h,
                ...
                (g = new FormData()),
                  ...
                  l.$progress && l.$progress.length && l.$progress.show(),
                  (v = function (r) {
                    (m = i._getOutData(g, r)),
                      i.showPreview &&
                        (p.hasClass("file-preview-success") ||
                          (i._setThumbStatus(p, "Loading"),
                          t.addCss(p, "file-uploading")),
                        f.attr("disabled", !0)),
                      i._raise("filechunkbeforesend", [c, e, a, o, l, m]);
                  }),
                  (h = function (t, n, s) {
                    ...
                    l.currThreads--,
                      t.error
                        ? (p.showErrorLog &&
                          ...
                          l.pushAjax(e, a + 1),
                          (l.error = t.error),
                          i._raise("filechunkerror", f))
                        : ((l.logs[t[u]] = !0),
                          l.processed[c] || (l.processed[c] = {}),
                          (l.processed[c][t[u]] = !0),
                          (l.processed[c].data = t),
                          i._raise("filechunksuccess", f),
                          l.check());
                  }),
                  (w = function (t, r, n) {
                    (m = i._getOutData(g, t)),
                      l.currThreads--,
                      (l.error = n),
                      l.logAjaxError(t, r, n),
                      i._raise("filechunkajaxerror", [c, e, a, o, l, m]),
                      l.pushAjax(e, a + 1);
                  }),
                  (b = function () {
            ...
            loopAjax: function () {
              var e = i.resumableManager;
              if (
                e.currThreads < i.resumableUploadOptions.maxThreads &&
                !e.testing
              ) {
                var t,
                  a = e.stack.shift();
                "undefined" != typeof a &&
                  ((t = a[0]),
                  e.processed[e.id] && e.processed[e.id][t]
                    ? e.processedResumables() >= e.getTotalChunks() &&
                      (e.setProcessed("success"),
                      clearInterval(e.chunkIntervalId))
                    : e.sendAjax(t, a[1]));
              }
            },
          }),
      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          (u =
            '<div id="' +
            t.MODAL_ID +
            '" class="file-zoom-dialog modal" tabindex="-1" aria-labelledby="' +
            t.MODAL_ID +
            'Label"></div>'),
          (p =
          ...
          N._isPdfRendered() &&
            ($ = N.pdfRendererTemplate.replace(
              "{renderer}",
              N._encodeURI(N.pdfRendererUrl)
            )),
          (N.defaults = {
            layoutTemplates: {
              main1: i,
          ...
          e.each(N.defaults, function (t, i) {
            return "allowedPreviewTypes" === t
              ? void (
                  void 0 === N.allowedPreviewTypes &&
                  (N.allowedPreviewTypes = i)
                )
              : void (N[t] = e.extend(!0, {}, i, N[t]));
          }),
        ...
        (i.previewCache = {
          ...
          get: function (a, r) {
            var n,
              ...
              h = g
                ? { title: g.title || null, alt: g.alt || null }
                : { title: null, alt: null },
            ...
            return m && m.length
              ? ((r = void 0 === r ? !0 : r),
                (l = t.ifSet("type", g, i.initialPreviewFileType || "generic")),
                (d = t.ifSet("filename", g, t.ifSet("caption", g))),
                (c = t.ifSet("filetype", g, l)),
                (s = i.previewCache.footer(a, r, (g && g.size) || null)),
                (u = t.ifSet("frameClass", g)),
                (n = v
                  ? w(l, m, d, c, s, p, u)
                  : w("generic", m, d, c, s, p, u, l).setTokens({
                      content: f.content[a],
                    })),
                f.tags.length && f.tags[a] && (n = t.replaceTags(n, f.tags[a])),
                t.isEmpty(g) ||
                  t.isEmpty(g.frameAttr) ||
                  ((o = e(document.createElement("div")).html(n)),
                  o.find(".file-preview-initial").attr(g.frameAttr),
                  (n = o.html()),
                  o.remove()),
                n)
              : "";
          ...
          footer: function (e, a, r) {
            ...
            var o,
              ...
              x = c === !1 && a;
            return (
              (_ = _ && l.downloadUrl !== !1 && !!v),
              (o = i._renderFileActions(l, !1, _, b, C, y, x, c, u, !0, v, h)),
              i
        ...
        t.autoOrientImageInitial &&
          t.getFrames(".file-preview-initial").each(function () {
            ...
            l &&
              ...
              l.exif.Orientation &&
              ((n = o.attr("id")),
              (a = o.find(">.kv-file-content img")),
              (r = t._getZoom(n, " >.kv-file-content img")),
              t.setImageOrientation(a, r, l.exif.Orientation, o)),
              i++;
          });
      },
      ...
      _setZoomContent: function (i, a) {
        ...
        (n = v.attr("data-template") || "generic"),
          ...
          h.data("previewId", m),
          g._handler(h.find(".btn-prev"), "click", function () {
        ...
        var r = this,
          ...
          o = function (e) {
            ...
            e.lengthComputable &&
              ...
              (o = t.round((s / l) * 100)),
              i
                ? r._setFileUploadStats(i, o, a, d)
                : r._setProgress(o, null, null, r._getStats(d)),
              r._raise("fileajaxprogress", [d]);
          };
        return (
          e.upload &&
            (r.progressDelay && (o = t.debounce(o, r.progressDelay)),
            e.upload.addEventListener("progress", o, !1)),
          e
        );
      },
      ...
      _ajaxSubmit: function (t, i, a, r, n, o, l, s) {
        ...
        f._raise("filepreajax", [n, o, l]) &&
          ...
          (p = function () {
            var t, i;
            f.ajaxCurrentThreads < f.maxAjaxThreads &&
              ((t = f.ajaxQueue.shift()),
              "undefined" != typeof t &&
                (f.ajaxCurrentThreads++,
                (i = e.ajax(t).done(function () {
      ...
      _uploadSingle: function (i, a, r) {
        ...
        w.enableResumableUpload ||
          ...
          0 === _ ||
              ...
              (f = w._parseError(T, t, n, w.fileManager.getFileName(a))),
                ...
                setTimeout(function () {
                  ...
                  r && h(),
                    ...
                    w._setPreviewError(o, !0),
                    w.retryErrorUploads || s.hide(),
                    e.extend(!0, I, w._getOutData(C, t)),
                    w._setProgress(
                      101,
                      w.$progress,
            ...
            C.append(w.uploadFileAttr, F.file, P),
      ...
      _previewFile: function (e, i, a, r, n) {
        if (this.showPreview) {
          ...
          "html" === u &&
            ...
            (o = l._generatePreviewTemplate(u, g, s, d, v, m, !1, f)),
            l._clearDefaultPreview(),
            l._addToPreview(p, o);
          var h = l._getFrame(v);
          l._validateImageOrientation(h.find("img"), i, v, m, c, d, f, g),
            l._setThumbAttr(v, c, f),
            l._initSortable();
        }
      },
      ...
      _toggleResumableProgress: function (e, t) {
        ...
        a &&
          a.length &&
          a.html(e.setTokens({ percent: 101, status: t, stats: "" }));
      },
      ...
      _validateImageOrientation: function (i, a, r, n, o, l, s, d) {
        ...
        return (
          (c = f ? p._getExifObj(d) : null),
          (u = c ? c["0th"][piexif.ImageIFD.Orientation] : null)
            ? (p.setImageOrientation(i, e(g), u, p._getFrame(r)),
              p._raise("fileimageoriented", { $img: i, file: a }),
              void p._validateImage(r, n, o, l, s, d, c))
            : void p._validateImage(r, n, o, l, s, d, c)
        );
      },
      ...
      _getResizedImage: function (i, a, r, n) {
        ...
        (I = I || v.resizeDefaultImageType),
          ...
          (T.height = b);
        try {
          F.drawImage(h, 0, 0, w, b),
            (d = T.toDataURL(I, v.resizeQuality)),
            S &&
      ...
      readFiles: function (i) {
        ...
        var a,
          ...
          w = function (t, n, o, l, s, d) {
            var c,
              u = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {
                id: o,
                index: l,
                fileId: s,
              }),
            ...
            (d = d || r.removeFromPreviewOnError),
              ...
              d && c.length
                ? c.remove()
                : (r._initFileActions(), c.find(".kv-file-upload").remove()),
              (r.isError = r.isAjaxUpload
                ? r._showFileError(t, u)
                : r._showError(t, f)),
              r._updateFileDetails(p);
          };
        r.fileManager.clearImages(),
          ...
          (a = function (b) {
            var _,
              C = r.$errorContainer,
              y = r.fileManager;
            if ((t.isEmpty(n.attr("multiple")) && (p = 1), b >= p))
              return (
                r.unlock(),
                r.duplicateErrors.length &&
                  ((_ = "<li>" + r.duplicateErrors.join("</li><li>") + "</li>"),
                  0 === C.find("ul").length
                    ? C.html(r.errorCloseButton + "<ul>" + _ + "</ul>")
                    : C.find("ul").append(_),
                  C.fadeIn(r.fadeDelay),
                  r._handler(C.find(".kv-error-close"), "click", function () {
                    C.fadeOut(r.fadeDelay);
                  }),
                  (r.duplicateErrors = [])),
                r.isAjaxUpload
                  ? (r._raise("filebatchselected", [y.stack]),
                    0 !== y.count() || r.isError || r.reset())
            ...
            if ($) {
              if (((S = y.getId($)), m > 0))
                for (T = 0; m > T; T++)
                  (E = g[T]),
                    (k = r.msgFileTypes[E] || E),
                    (V += 0 === T ? k : ", " + k);
              if (Z === !1) return void a(b + 1);
              if (0 === Z.length)
                return (
                  (F = r.msgInvalidFileName.replace(
                    "{name}",
              ...
              if (
                ...
                (x = N.toFixed(2)),
                (r.isAjaxUpload && y.exists(S)) || r._getFrame(R, !0).length)
              ) {
                var Q = { id: R, index: b, fileId: S, file: $, files: i };
                return (
                  (F = r.msgDuplicateFile.setTokens({ name: Z, size: x })),
                  void (r.isAjaxUpload
                    ? setTimeout(function () {
                        r.duplicateErrors.push(F),
                          r._raise("fileduplicateerror", [$, S, Z, x, R, b]),
                          a(b + 1),
                          r._updateFileDetails(p);
                      }, r.processDelay)
                    : (r._showError(F, Q),
              ...
              if (!t.isEmpty(g) && t.isArray(g)) {
                for (T = 0; T < g.length; T += 1)
                  (I = g[T]),
                    (D = f[I]),
                    (q +=
                      D && "function" == typeof D && D($.type, t.getFileName($))
                        ? 1
                        : 0);
                if (0 === q)
                  return (
                    (F = r.msgInvalidFileType.setTokens({ name: Z, types: V })),
                    void w(F, $, R, b, S)
                  );
              }
              if (
                ...
                !t.isEmpty(H) &&
                ((P = t.compare(Z, H)),
                (q += t.isEmpty(P) ? 0 : P.length),
                0 === q)
              )
                return (
                  (F = r.msgInvalidFileExtension.setTokens({
                    name: Z,
                    extensions: h,
                  })),
                  void w(F, $, R, b, S)
              ...
              if (!r._canPreview($))
                return (
                  (A = r.isAjaxUpload && r._raise("filebeforeload", [$, b, o])),
                  r.isAjaxUpload && A && y.add($),
                  r.showPreview &&
                    A &&
                  ...
                  void setTimeout(function () {
                    A && r._updateFileDetails(p),
                      a(b + 1),
                      r._raise("fileloaded", [$, R, b]);
                  }, 10)
                );
              (z = O($.type, Z)),
                (M = L($.type, Z)),
                (U = B($.type, Z)),
                s.html(d.replace("{index}", b + 1).replace("{files}", p)),
                l.addClass("file-thumb-loading"),
                ...
                (o.onload = function (i) {
                  var a,
                    ...
                    p = function (e) {
                      ...
                      (t.onerror = function (e) {
                        ...
                        (t.onload = function (e) {
                          (r.isAjaxUpload &&
                            !r._raise("filebeforeload", [$, b, o])) ||
                            (r._previewFile(b, $, e, W, n),
                            r._initFileActions(),
                            K());
                        }),
                        e
                          ? t.readAsText($, r.textEncoding)
                          : t.readAsDataURL($);
                    };
                  if (
                    ((n = { name: Z, type: $.type }),
                    ...
                    for (
                      l = new Uint8Array(i.target.result), T = 0;
                      T < l.length;
                      T++
                    )
                      (s = l[T].toString(16)), u.push(s);
                    if (
                  ...
                  (r.isAjaxUpload && !r._raise("filebeforeload", [$, b, o])) ||
                    (r._previewFile(b, $, i, W, n), r._initFileActions(), K());
                }),
      ...
      pause: function () {
        ...
        if (
          (a.chunkIntervalId && clearInterval(a.chunkIntervalId),
          i.ajaxQueueIntervalId && clearInterval(i.ajaxQueueIntervalId),
      ...
      cancel: function () {
        var t,
          ...
          n = a.length;
        if (
          (i.enableResumableUpload && r.chunkIntervalId
            ? (clearInterval(r.chunkIntervalId),
              r.reset(),
